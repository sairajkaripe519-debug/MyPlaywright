...
test.only(`Test to handle multiple windows `, async({page, context}) => {
    ...
    //await page.screenshot({path: `/Users/sairajkarpe/Sairaj Education/MyPlaywright/tests/day09/windowhandling.png`});

    console.log(await allpages[1].title());

    await page.waitForTimeout(1000);

    //await page.screenshot({path: `/Users/sairajkarpe/Sairaj Education/MyPlaywright/tests/day09/windowhandling_child.png`});

    // console.log(await allpages[2].title());

    // await page.waitForTimeout(1000);

    //await page.screenshot({path: `/Users/sairajkarpe/Sairaj Education/MyPlaywright/tests/day09/windowhandling_child2.png`});
